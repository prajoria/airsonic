 ...
 */
@Controller
@RequestMapping("/audiobooksSettings")
public class AudioBooksSettingsController {

    private static final Logger LOG = LoggerFactory.getLogger(AudioBooksSettingsController.class);
    ...
    protected String onSubmit(@ModelAttribute("command") MusicFolderSettingsCommand command, RedirectAttributes redirectAttributes) throws Exception {
        ...
        return "redirect:audiobooksSettings.view";
    }
