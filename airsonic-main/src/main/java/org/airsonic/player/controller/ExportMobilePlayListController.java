 ...
 */
@Controller
@RequestMapping("/exportMobilePlaylist")
public class ExportMobilePlayListController {


    private static final Logger LOG = LoggerFactory.getLogger(ExportMobilePlayListController.class);
    ...
    public ModelAndView exportPlaylist(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        playlistService.exportMobilePlaylist(id, response.getOutputStream());
        return null;
    }
